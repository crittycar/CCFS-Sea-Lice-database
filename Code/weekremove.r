...
JDweeklyintervals<-julian(best2020$date)
JDweeklyintervals<-unique(JDweeklyintervals)
...
View(motmeanboot)
motmeanboot$weeklyintvl <-as.Date(motmeanboot$weeklyintvl, origin=as.Date("1970-01-01"))
...
library(reshape2)
Ritchieweeklies$Week <- factor(Ritchieweeklies$Week, c("Apr 18 20","Apr 24 20","Apr 30 20","May 08 20","May 15 20","May 23 20" ,"May 30 20","Jun 05 20","Jun 12 20"))
